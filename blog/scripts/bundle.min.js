...
"gm"),css:"keyword"},{regex:RegExp("[_:=><%#@]+","gm"),css:"keyword"}]}"undefined"!=typeof require&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["scala"];SyntaxHighlighter.brushes.Scala=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*
...
"gm"),css:"functions"}]}"undefined"!=typeof require&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["bash","shell"];SyntaxHighlighter.brushes.Bash=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*

 Dual licensed under the MIT and GPL licenses.
*/
(function(){function a(){this.regexList=[{regex:SyntaxHighlighter.regexLib.singleLineCComments,css:"comments"},{regex:/\/\*([^\*][\s\S]*)?\*\//gm,css:"comments"},{regex:/\/\*(?!\*\/)\*[\s\S]*?\*\//gm,css:"preprocessor"},{regex:SyntaxHighlighter.regexLib.doubleQuotedString,css:"string"},{regex:SyntaxHighlighter.regexLib.singleQuotedString,css:"string"},{regex:/\b([\d]+(\.[\d]+)?|0x[a-f0-9]+)\b/gi,css:"value"},{regex:/(?!\@interface\b)\@[\$\w]+\b/g,css:"color1"},{regex:/\@interface\b/g,css:"color2"},
{regex:RegExp(this.getKeywords("abstract assert boolean break byte case catch char class const continue default do double else enum extends false final finally float for goto if implements import instanceof int interface long native new null package private protected public return short static strictfp super switch synchronized this throw throws true transient try void volatile while"),"gm"),css:"keyword"}];this.forHtmlScript({left:/(&lt;|<)%[@!=]?/g,right:/%(&gt;|>)/g})}"undefined"!=typeof require&&
(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["java"];SyntaxHighlighter.brushes.Java=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*
...
"gm"),css:"keyword"}];this.forHtmlScript(SyntaxHighlighter.regexLib.aspScriptTags)}"undefined"!=typeof require&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["vb","vbnet"];SyntaxHighlighter.brushes.Vb=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*
...
"gm"),css:"keyword bold"}]}"undefined"!=typeof require&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["cpp","c"];SyntaxHighlighter.brushes.Cpp=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*
...
"gm"),css:"keyword"}];this.forHtmlScript(SyntaxHighlighter.regexLib.phpScriptTags)}"undefined"!=typeof require&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["php"];SyntaxHighlighter.brushes.Php=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*
...
typeof exports&&(exports.Brush=a)})();/*
 ...
 Dual licensed under the MIT and GPL licenses.
*/
(function(){function a(){}"undefined"!=typeof require&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["text","plain"];SyntaxHighlighter.brushes.Plain=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*

 Dual licensed under the MIT and GPL licenses.
*/
(function(){function a(){this.regexList=[{regex:/^\+\+\+.*$/gm,css:"color2"},{regex:/^\-\-\-.*$/gm,css:"color2"},{regex:/^\s.*$/gm,css:"color1"},{regex:/^@@.*@@$/gm,css:"variable"},{regex:/^\+[^\+]{1}.*$/gm,css:"string"},{regex:/^\-[^\-]{1}.*$/gm,css:"comments"}]}"undefined"!=typeof require&&(SyntaxHighlighter=require("shCore").SyntaxHighlighter);a.prototype=new SyntaxHighlighter.Highlighter;a.aliases=["diff","patch"];SyntaxHighlighter.brushes.Diff=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*
...
a.aliases=["py","python"];SyntaxHighlighter.brushes.Python=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*
...
a.aliases=["ruby","rails","ror","rb"];SyntaxHighlighter.brushes.Ruby=a;"undefined"!=typeof exports&&(exports.Brush=a)})();/*

 Dual licensed under the MIT and GPL licenses.
*/
(function(){function a(){var a=SyntaxHighlighter.regexLib;this.regexList=[{regex:a.multiLineCComments,css:"comments"},{regex:a.singleLineCComments,css:"comments"},{regex:a.doubleQuotedString,css:"string"},{regex:a.singleQuotedString,css:"string"},{regex:/\#[a-fA-F0-9]{3,6}/g,css:"value"},{regex:/\b(-?\d+)(\.\d+)?(px|em|pt|\:|\%|)\b/g,css:"value"},{regex:/\$\w+/g,css:"variable"},{regex:RegExp(this.getKeywords("!important !default"),"g"),css:"color3"},{regex:RegExp(this.getKeywords("@import @extend @debug @warn @if @for @while @mixin @include"),
"g"),css:"preprocessor"},{regex:RegExp("\\b([a-z_]|)"+"ascent azimuth background-attachment background-color background-image background-position background-repeat background baseline bbox border-collapse border-color border-spacing border-style border-top border-right border-bottom border-left border-top-color border-right-color border-bottom-color border-left-color border-top-style border-right-style border-bottom-style border-left-style border-top-width border-right-width border-bottom-width border-left-width border-width border bottom cap-height caption-side centerline clear clip color content counter-increment counter-reset cue-after cue-before cue cursor definition-src descent direction display elevation empty-cells float font-size-adjust font-family font-size font-stretch font-style font-variant font-weight font height left letter-spacing line-height list-style-image list-style-position list-style-type list-style margin-top margin-right margin-bottom margin-left margin marker-offset marks mathline max-height max-width min-height min-width orphans outline-color outline-style outline-width outline overflow padding-top padding-right padding-bottom padding-left padding page page-break-after page-break-before page-break-inside pause pause-after pause-before pitch pitch-range play-during position quotes right richness size slope src speak-header speak-numeral speak-punctuation speak speech-rate stemh stemv stress table-layout text-align top text-decoration text-indent text-shadow text-transform unicode-bidi unicode-range units-per-em vertical-align visibility voice-family volume white-space widows width widths word-spacing x-height z-index".replace(/ /g,
